...
const AboutPage = () => {
  ...
  let valuesRef = useRef<HTMLDivElement>(null);
  let sustainabilityRef = useRef<HTMLDivElement>(null);

  const handleScroll = (elementReference: React.RefObject<HTMLDivElement>) => {
  ...
  return (
    <Layout disablePaddingBottom>
      <div className={styles.root}>
        ...
        <Hero
          maxWidth={'900px'}
          image={'https://drive.google.com/file/d/1d39-QaPs7YgruJ8nxaTO97FBUHzqazS1/view?usp=sharing'}
        ...
        <div className={styles.imageContainer}>
          <img alt={'shirt brand'} src={extractImageSrcFromUrlAsUC('https://drive.google.com/file/d/1fb8sGcgyt0711p_YDVLrdNWXLZlIqRTa/view?usp=sharing') || NotFoundImage}></img>
        </div>
        ...
        <Container size={'large'} spacing={'min'}>
          <div className={styles.content}>
            ...
            <div ref={valuesRef}>
              ...
              <img
                alt={'founder'}
                src={extractImageSrcFromUrlAsUC('https://drive.google.com/file/d/1-sqvC9RcPOqEf6qnaPURDsyrLcdjuO_J/view?usp=sharing') || NotFoundImage}
              ></img>
            </div>
        ...
        <div className={styles.imageContainer}>
          <img alt={'shirt backwards'} src={extractImageSrcFromUrlAsUC('https://drive.google.com/file/d/1yR4QZzNFhrljllGp-2fKeqsQ9--KorFt/view?usp=sharing') || NotFoundImage}></img>
        </div>
      </div>
    </Layout>
  );
